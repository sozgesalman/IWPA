...
namespace Devkit.SM
{
    ...
    public abstract class StateMachine 
    {
        ...
        public void AddTransition(StateMachine sourceStateMachine, StateMachine targetStateMachine, int trigger)
        {
            ...
            {
                Debug.LogWarning("Dublicated transition!" +trigger);
                return;
            }
        ...
        public void AddSubStates(StateMachine subState)
        {
        ...
        public void SendTrigger(int trigger)
        {
            ...
            while(root != null)
            {
                ...
                {
                    root.parent?.ChangeSubStates(toState);
                    return;
                }
        ...
        private void ChangeSubStates(StateMachine state)
        {
            if(currentSubState != null)
            {
                currentSubState.Exit();
        ...
        {
            ChangeSubStates(defaultSubState);
        }
    }
}
